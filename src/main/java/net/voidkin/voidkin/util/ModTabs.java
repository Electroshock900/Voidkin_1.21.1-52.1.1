...
public class ModTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, VoidkinMod.MODID);


    public static final RegistryObject<CreativeModeTab> PSYCHO_TAB = CREATIVE_MODE_TABS.register("psycho_tab",
