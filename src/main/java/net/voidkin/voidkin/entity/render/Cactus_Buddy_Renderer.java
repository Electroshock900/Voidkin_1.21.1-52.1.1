    ...
    private static final Map<CactusBuddyVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(CactusBuddyVariant.class), map -> {
                map.put(CactusBuddyVariant.REGULAR,
                        ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "textures/entity/custom/cactus_buddy.png"));
                map.put(CactusBuddyVariant.BLOOD,
                        ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "textures/entity/custom/cactus_buddy_nether.png"));
                map.put(CactusBuddyVariant.DRY,
                        ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "textures/entity/custom/cactus_buddy_ender.png"));
