...
import net.voidkin.voidkin.entity.model.TomahawkProjectileModel;
import net.voidkin.voidkin.entity.projectiles.TomahawkProjectileEntity;
...
public class TomahawkProjectileRenderer extends EntityRenderer<TomahawkProjectileEntity> {
    ...
    public ResourceLocation getTextureLocation(TomahawkProjectileEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "textures/entity/tomahawk/tomahawk.png");
    }
}