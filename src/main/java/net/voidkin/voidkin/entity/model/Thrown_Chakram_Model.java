...
public class Thrown_Chakram_Model<T extends Thrown_Chakram> extends HierarchicalModel<Thrown_Chakram> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "thrown_chakram"), "main");
	private final ModelPart group2;

	public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID,"textures/entity/projectile/chakram.png");
