...
import net.voidkin.voidkin.entity.animation.WarTurtleAnimation;
...
public class War_Turtle_Model<T extends WarTurtle> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "war_turtle"), "main");
	public static final ModelLayerLocation ARMOR_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "war_turtle"), "armor");

	//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(VoidkinMod.MODID, "wartutel"), "main");
