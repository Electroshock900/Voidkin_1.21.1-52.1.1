...
public class SideAltarBlockEntityRenderer implements BlockEntityRenderer<VoidPedestalBlockEntity> {
    public SideAltarBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
