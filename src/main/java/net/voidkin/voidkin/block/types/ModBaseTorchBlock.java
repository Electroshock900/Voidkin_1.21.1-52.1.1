...
public abstract class ModBaseTorchBlock extends Block{
    protected static final int AABB_STANDING_OFFSET = 2;
    protected static final VoxelShape AABB = Block.box(6.0, 0.0, 6.0, 10.0, 10.0, 10.0);

    protected ModBaseTorchBlock(BlockBehaviour.Properties p_310835_) {
        super(p_310835_);
    }

    @Override
    protected abstract MapCodec<? extends ModBaseTorchBlock> codec();
