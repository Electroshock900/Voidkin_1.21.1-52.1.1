...
public class ModItems {
    ...
    public static final RegistryObject<Item> VOID_TORCH = ITEMS.register("void_torch", ()-> new StandingAndWallBlockItem(ModBlocks.VOID_TORCH.get(),ModBlocks.VOID_WALL_TORCH.get(), new Item.Properties(), Direction.DOWN));
    public static final RegistryObject<Item> D_TORCH = ITEMS.register("d_torch", ()-> new StandingAndWallBlockItem(ModBlocks.D_TORCH.get(),ModBlocks.D_WALL_TORCH.get(), new Item.Properties(), Direction.DOWN));

    public static final RegistryObject<Item> CANDY_CANE_SUGAR = ITEMS.register("candy_cane_sugar", () -> new ModFuelItem(new Item.Properties(),640));
    public static final RegistryObject<Item> SMILE = ITEMS.register("smile", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> FIRE_CHARM = ITEMS.register("fire_charm", () -> new Item(new Item.Properties().fireResistant()));
...
//Weapons and Shields
    ...
    public static final RegistryObject<Item> SCYTHE = ITEMS.register("scythe", ()-> new SwordItem(ModMaterials.DARKNESS, new Item.Properties()));
...
//Spawn Eggs
    ...
    public static final RegistryObject<Item> HOSE = ITEMS.register("horned_owl_egg", () -> new ForgeSpawnEggItem(ModEntities.HORNED_OWL,0x773d3d,0xcba5a5,new Item.Properties()));
...
//Buckets
    ...
    public static final RegistryObject<Item> ENDER_BLOOD_BUCKET = ITEMS.register("ender_blood_bucket",
            () -> new BucketItem(ModFluids.SOURCE_ENDER_BLOOD,
                    new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
   ...
   public static final RegistryObject<Item> DEITY_BLOOD_BUCKET = ITEMS.register("deity_blood_bucket",
            () -> new BucketItem(ModFluids.SOURCE_DEITY_BLOOD,
                    new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    public static final RegistryObject<Item> DARK_ESSENCE_BUCKET = ITEMS.register("dark_essense_bucket",
            () -> new BucketItem(ModFluids.SOURCE_DARK_ESSENCE,
                    new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
...
//Armor
    ...
    public static final RegistryObject<Item> FROSTBOOTS = ITEMS.register("frostboots",
...
//Boats
    ...
    public static final RegistryObject<Item> BLOOD_BOAT = ITEMS.register("blood_boat",
            () -> new ModBoatItem(false, ModBoatEntity.Type.BLOOD, new Item.Properties()));
    public static final RegistryObject<Item> BLOOD_CHEST_BOAT = ITEMS.register("blood_chest_boat",
...
//MusicDiscs
    ...
    public static final RegistryObject<Item> GRAVITY_MUSIC_DISC = ITEMS.register("gravity_music_disc",
            ()-> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSounds.GRAVITY_KEY)));
    public static final RegistryObject<Item> DAISIES_MUSIC_DISC = ITEMS.register("daisies_music_disc",
            ()-> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSounds.DAISIES_KEY)));
    public static final RegistryObject<Item> UPSIDE_DOWN_MUSIC_DISC = ITEMS.register("upside_down_music_disc",
            ()-> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSounds.UPSIDE_DOWN_KEY)));
    public static final RegistryObject<Item> ALASTOR_MASHUP_MUSIC_DISC = ITEMS.register("alastor_mashup_music_disc",
            ()-> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSounds.ALASTOR_KEY)));
    public static final RegistryObject<Item> LOSER_BABY_MUSIC_DISC = ITEMS.register("loser_baby_music_disc",
            ()-> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSounds.LOSER_BABY_KEY)));
    public static final RegistryObject<Item> LOSIN_STREAK_MUSIC_DISC = ITEMS.register("losin_streak_music_disc",
            ()-> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSounds.LOSIN_STREAK_KEY)));
    public static final RegistryObject<Item> HUSK_LOVE_MUSIC_DISC = ITEMS.register("husk_love_music_disc",
            ()-> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSounds.HUSK_LOVE_KEY)));
    public static final RegistryObject<Item> BRIGHTER_MUSIC_DISC = ITEMS.register("brighter_music_disc",
