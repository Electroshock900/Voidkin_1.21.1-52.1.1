...
//                .collect(Collectors.toList());
    ...
    private Item getSaplingByLeaf(Level pLevel,List<BlockPos> leavesPos) {
        if (leavesPos.isEmpty()) {
            ...
            return ForgeRegistries.ITEMS.getValue(ResourceLocation.withDefaultNamespace("air"));
        }
        ...
        return ForgeRegistries.ITEMS.getValue(ResourceLocation.tryParse(sapling));
    }
