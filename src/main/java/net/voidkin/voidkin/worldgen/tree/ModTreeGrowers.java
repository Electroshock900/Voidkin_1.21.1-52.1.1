...
public class ModTreeGrowers {
    public static final TreeGrower DARK = new TreeGrower(VoidkinMod.MODID + ":dark",
            Optional.empty(), Optional.of(ModConfiguredFeatures.DARK_TREE_KEY), Optional.empty());
    public static final TreeGrower BLOOD = new TreeGrower(VoidkinMod.MODID + ":blood",
            Optional.empty(), Optional.of(ModConfiguredFeatures.BLOOD_TREE_KEY), Optional.empty());
    public static final TreeGrower VOID = new TreeGrower(VoidkinMod.MODID + ":void",
