package net.voidkin.voidkin.worldgen.dimension;
...
public class ModDimensions {
    ...
    public static final ResourceKey<LevelStem> DEATH_DIM_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "death_dim"));
    //LEVELS
    ...
    public static final ResourceKey<DimensionType> DEATH_DIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "death_dim_type"));
        ...
        NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
                MultiNoiseBiomeSource.createFromList(
                        new Climate.ParameterList<>(List.of(
                                Pair.of(Climate.parameters(0.4F, 0.0F, 0.2F, 0.1F, 0.3F, 0.7F, 0.2F), biomeRegistry.getOrThrow(ModBiomes.DARK_BIOME)),
                                ...
                                Pair.of(Climate.parameters(0.1F, 0.6F, 0.1F, 0.1F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(ModBiomes.BLOOD_OCEAN)),

                                Pair.of(Climate.parameters(0.4F, 0.3F, 0.2F, 0.1F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(Biomes.DARK_FOREST)),
                                Pair.of(Climate.parameters(0.0F, 0.4F, 0.3F, 0.1F, 0.0F, 0.2F, 0.3F), biomeRegistry.getOrThrow(ModBiomes.DARKLANDS))
