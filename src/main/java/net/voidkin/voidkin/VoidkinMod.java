...
public class VoidkinMod
{
    ...
    public VoidkinMod(FMLJavaModLoadingContext context)
    {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        if(event.getTabKey() == CreativeModeTabs.SPAWN_EGGS){
            event.accept(ModItems.CBSE.get());
            event.accept(ModItems.EMSE.get());
            event.accept(ModItems.SSE.get());
            event.accept(ModItems.MSSE.get());
            event.accept(ModItems.LTSE.get());
            event.accept(ModItems.MRSE.get());
            event.accept(ModItems.OSE.get());
            event.accept(ModItems.PSE.get());
        }
    }
