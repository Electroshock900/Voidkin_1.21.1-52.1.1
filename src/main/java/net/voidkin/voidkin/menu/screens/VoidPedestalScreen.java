...
public class VoidPedestalScreen extends AbstractContainerScreen<VoidPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "textures/gui/altar_gui2.png");

    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(VoidkinMod.MODID, "textures/gui/crystallizer/arrow_progress.png");

    private static final ResourceLocation CRYSTAL_TEXTURE =
            ResourceLocation.parse("textures/block/amethyst_cluster.png");

    public VoidPedestalScreen(VoidPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
