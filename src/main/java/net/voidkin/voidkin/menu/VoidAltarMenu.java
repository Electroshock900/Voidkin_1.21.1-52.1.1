...
public class VoidAltarMenu extends AbstractContainerMenu {
    ...
    public VoidAltarMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 80, 7));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 106, 7));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 52, 35));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 52, 7));
            this.addSlot(new SlotItemHandler(iItemHandler, 5, 106, 35));
            this.addSlot(new SlotItemHandler(iItemHandler, 6, 52, 62));
            this.addSlot(new SlotItemHandler(iItemHandler, 7, 80, 62));
            this.addSlot(new SlotItemHandler(iItemHandler, 8, 106, 62));
                //this.addSlot(new SlotItemHandler(iItemHandler, 1, 64, 59));
            });
        addDataSlots(data);
    }
